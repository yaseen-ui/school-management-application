...
-- CreateIndex
CREATE UNIQUE INDEX "exam_papers_id_tenantId_key" ON "exam_papers"("id", "tenantId");
...
-- AddForeignKey
ALTER TABLE "attendance_sessions" ADD CONSTRAINT "attendance_sessions_periodId_tenantId_fkey" FOREIGN KEY ("periodId", "tenantId") REFERENCES "timetable_periods"("id", "tenantId") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "attendance_sessions" ADD CONSTRAINT "attendance_sessions_teacherAssignmentId_tenantId_fkey" FOREIGN KEY ("teacherAssignmentId", "tenantId") REFERENCES "teacher_assignments"("id", "tenantId") ON DELETE NO ACTION ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "exam_papers" ADD CONSTRAINT "exam_papers_examId_tenantId_fkey" FOREIGN KEY ("examId", "tenantId") REFERENCES "exams"("id", "tenantId") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "exam_marks" ADD CONSTRAINT "exam_marks_examPaperId_tenantId_fkey" FOREIGN KEY ("examPaperId", "tenantId") REFERENCES "exam_papers"("id", "tenantId") ON DELETE CASCADE ON UPDATE CASCADE;
