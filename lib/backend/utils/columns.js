export const tableColumns = {
  ...
  vehicleCategories: [
    { field: "name", headerName: "Category Name" },
    { field: "type", headerName: "Vehicle Type" },
    { field: "occupancy", headerName: "Occupancy" },
    { field: "amenities", headerName: "Amenities" },
    { field: "description", headerName: "Description" },
    { field: "isActive", headerName: "Active", type: "boolean" },
    { field: "_count.vehicles", headerName: "Vehicles" },
    { field: "createdAt", headerName: "Created At" },
    { field: "updatedAt", headerName: "Updated At" },
  ],
  vehicles: [
  ...
  vehicleDriverAssignments: [
    { field: "vehicle.name", headerName: "Vehicle" },
    { field: "driver.fullName", headerName: "Driver" },
    { field: "isPrimaryDriver", headerName: "Primary Driver", type: "boolean" },
  ...
  pickupPoints: [
    { field: "name", headerName: "Pickup Point Name" },
  ...
  studentTransportAssignments: [
    ...
    { field: "enrollment.student.lastName", headerName: "Student Last Name" },
    { field: "enrollment.rollNumber", headerName: "Roll Number" },
    { field: "pickupPoint.name", headerName: "Pickup Point" },
    { field: "vehicle.name", headerName: "Vehicle" },
    { field: "vehicleCategory.name", headerName: "Vehicle Category" },
    { field: "status", headerName: "Status" },
    { field: "startDate", headerName: "Start Date" },
    { field: "endDate", headerName: "End Date" },
    { field: "createdAt", headerName: "Created At" },
