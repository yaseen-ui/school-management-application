...
class TeachersController {
  ...
  async getEligibleTeachers(req, res) {
    try {
      const { tenantId } = req.user;
      const { sectionSubjectId, role } = req.query;
      const eligible = await TeachersService.getEligibleTeachers(
        sectionSubjectId,
        role,
        tenantId
      );
      ...
      logger.error("Error retrieving eligible teachers:", error);
      return responseHandler(res, "error", null, error.message);
    }
  }
  ...
  async sendInvite(req, res) {
    try {
      ...
      const result = await TeachersService.sendInvite(teacherId, tenantId);
      return responseHandler(res, "success", result, "Invite sent successfully.");
    } catch (error) {
      logger.error("Error sending staff invite:", error);
      return responseHandler(res, "error", null, error.message);
    }
  }
  ...
  async validateInviteToken(req, res) {
    try {
      ...
      const result = await TeachersService.validateInviteToken(token);
      return responseHandler(res, "success", result, "Token is valid.");
    } catch (error) {
      logger.error("Error validating staff invite token:", error);
      return responseHandler(res, "error", null, error.message);
    }
  }
  ...
  async registerTeacher(req, res) {
    try {
      ...
      const result = await TeachersService.registerTeacher({ token, email, phone, password });
