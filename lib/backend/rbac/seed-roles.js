...
const DEFAULT_ROLES = [
  ...
  },
  {
    ...
    permissions: [
      ...
      'query-bot:ask',
      // Hostel (full operational access; allocate + staff assign)
      'hostel:read', 'hostel:manage', 'hostel:assign-staff', 'hostel:allocate',
      // Payroll (view + config; process reserved for dedicated payroll ops / admin)
      'payroll:read',
      'salary-components:read', 'salary-components:write',
      'compensation:read', 'compensation:write',
      // Communication
      'communication-notifications:read', 'communication-notifications:write',
      'communication-publications:read', 'communication-publications:write',
  ...
  },
  {
    ...
    permissions: [
      ...
      'academic-years:read', 'academic-years:write', 'academic-years:edit',
      'reports:view',
      // Communication — compose notifications; read publications
      'communication-notifications:read', 'communication-notifications:write',
  ...
  },
  {
    ...
    permissions: [
      ...
      // Payroll processing for finance staff
  ...
  },
  {
    ...
    permissions: [
      ...
      'holidays:read',
      'leave:read',
      // Communication — view notification history only
