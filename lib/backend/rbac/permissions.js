...
const PERMISSIONS = {
  ...
  // ─────────────────────────────────────────────────
  // Communication (notifications, publications, automation)
  // NOTE: Use 2-part codes (module:action) only.
  // 3-part codes are reserved for scopes (e.g. students:read:section).
  // Using communication:notifications:read would break matching
  // (read/write would incorrectly grant each other via scope logic).
  // ─────────────────────────────────────────────────
  'communication-notifications:read': {
    module: 'communication_notifications',
    action: 'read',
    scope: null,
    description: 'View notification history and delivery reports',
  },
  'communication-notifications:write': {
    module: 'communication_notifications',
    action: 'write',
    scope: null,
    description: 'Compose and send notifications',
  },
  'communication-publications:read': {
    module: 'communication_publications',
    action: 'read',
    scope: null,
    description: 'View publications',
  },
  'communication-publications:write': {
    module: 'communication_publications',
    action: 'write',
    scope: null,
    description: 'Create, edit, submit, publish, and archive publications',
  },
  'communication-publications:approve': {
    module: 'communication_publications',
    action: 'approve',
    scope: null,
    description: 'Approve or reject publications in the workflow',
  },
  'communication-automation:manage': {
    module: 'communication_automation',
    action: 'manage',
    scope: null,
    description: 'Manage communication automation rules',
  },
  ...
  'communication-channels:manage': {
    ...
    action: 'manage',
    scope: null,
    description: 'Configure communication channels (email, SMS, WhatsApp, etc.)',
  },
  ...
  'query-bot:ask': {
    ...
    action: 'ask',
    scope: null,
    description: 'Use AI-powered natural language queries to fetch data',
  },
  ...
  'hostel:read': {
    ...
    action: 'read',
    scope: null,
    description: 'View hostel blocks, floors, rooms, room types, and sections',
  },
  'hostel:manage': {
    module: 'hostel',
    action: 'manage',
    scope: null,
    description: 'Create, edit, and delete hostel blocks, floors, rooms, room types, and sections',
  },
  'hostel:assign-staff': {
    module: 'hostel',
    action: 'assign-staff',
    scope: null,
    description: 'Assign wardens, in-charges, cooks, mates, and other staff to hostel blocks',
  },
  'hostel:allocate': {
    module: 'hostel',
    action: 'allocate',
    scope: null,
    description: 'Allocate students to hostel rooms and manage allocations',
  },
